...
By default the template creates a single `HelloWorld` contract under stake_guide_contracts folder in the `smart_contracts` directory. To add a new contract:
